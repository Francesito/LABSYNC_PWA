...
export default function Sidebar() {
  ...
  const getItemColorClasses = (color) => {
    const colorMap = {
      ...
      emerald: 'hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-200 group-hover:text-emerald-500',
      amber: 'hover:bg-amber-50 hover:text-amber-700 hover:border-amber-200 group-hover:text-amber-500',
      purple: 'hover:bg-purple-50 hover:text-purple-700 hover:border-purple-200 group-hover:text-purple-500',
      indigo: 'hover:bg-indigo-50 hover:text-indigo-700 hover:border-indigo-200 group-hover:text-indigo-500',
      rose: 'hover:bg-rose-50 hover:text-rose-700 hover:border-rose-200 group-hover:text-rose-500',
    };
    return colorMap[color] || 'hover:bg-gray-50 hover:text-gray-700 hover:border-gray-200 group-hover:text-gray-500';
  };
    ...
    <aside className="w-64 h-screen bg-white border-r border-gray-200 flex flex-col fixed z-20 shadow-lg">
      ...
      <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
        <div className="flex items-center gap-4">
          <div className="relative">
            <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${getRoleColor(usuario.rol_id)} flex items-center justify-center shadow-md`}>
      ...
      <div className="p-4 border-t border-gray-100">
        <button
          ...
          className="group flex items-center gap-3 w-full px-3 py-2.5 text-sm font-medium text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 border border-transparent hover:border-red-100"
        >
